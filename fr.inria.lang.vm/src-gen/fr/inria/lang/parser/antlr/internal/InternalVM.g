...
(
		lv_not_3_0=	'not' 
    {
        newLeafNode(lv_not_3_0, grammarAccess.getConstraintAccess().getNotNotKeyword_1_0());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getConstraintAccess().getExpressionSubExpression0ParserRuleCall_2_0()); 
	    }
		lv_expression_4_0=ruleSubExpression0		{
	        if ($current==null) {
